...
const caseStudies = [
  {
    ...
    detail: "Top 3 Google Maps ranking within 60 days through GMB optimization and local SEO",
    metric: "2 → 18",
  ...
  },
  {
    ...
    detail: "Technical SEO overhaul, content strategy, and local keyword targeting",
    metric: "120 → 530",
